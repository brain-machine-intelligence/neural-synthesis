...
for i = 1 : numepochs
    ...
    m = size(train_x, 1);
    kk = randperm(m);
    nn.learningRate = nn.learningRate*0.98;
    nn.norm_learningRate= nn.norm_learningRate*0.98;
    for l = 1 : numbatches
    ...
    if opts.validation == 1 && nn.is_six==0%&& i == numepochs
    ...
    elseif opts.validation==1 && nn.is_six==1 && i==numepochs
